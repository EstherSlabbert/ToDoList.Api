...
// Microsoft Public License (MS_PL, http://opensource.org/licenses/ms-pl.html
//
...
namespace ToDoList.Common.Linq;
...
internal class ClassFactory
{
    ...
    private ClassFactory()
    {
        ...
        // old.net: AssemblyBuilder assembly = AppDomain.CurrentDomain.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run);
...
#pragma warning restore 0219
    ...
    // ORIGINAL, but following working solution from EnterpriseMetrics solution
    //// ?: operator
    ...
    Expression ParseAggregate(Expression instance, Type elementType, string methodName, int errorPos)
    {
        ...
        //           || signature.GetParameters().Last().ParameterType == typeof(System.Collections.IEnumerable)
    ...
    Expression ParseElementAccess(Expression expr)
    {
        ...
        else
        {
            return FindIndexer(expr.Type, args, out MethodBase mb) switch
            {
                ...
                _ => throw ParseError(errorPos, Res.AmbiguousIndexerInvocation,
                        GetTypeName(expr.Type))
            };
        }
    }
